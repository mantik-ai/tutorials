...
For more information on how to setup such a project, see [the user guide](#user-guide) and the tutorials.
...
The tracking server is secured by username and password, see also the [security section](#security).
...
Besides parameters and metrics, also so-called artifacts can be logged. Artifacts can be any files. You are free to log any file like object with the 

"""
This script contains code taken from Timo Stomberg's repository:
https://gitlab.jsc.fz-juelich.de/kiste/asos/-/tree/main/
...
def evaluate(trainer):
    ...
    dataset = trainer.datamodule.get_dataset(
        files=fi.df.index, labels=fi.df.label, prepend_folder=True
    )
